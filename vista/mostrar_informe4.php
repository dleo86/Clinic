...
$mensaje='';
 $consulta = $conexion -> prepare("
    ...
    foreach ($consulta as $row){
       ...
       // $color = 'stroke-color: #703593; stroke-width: 4; fill-color: #C5A5CF';
...
<head>
    ...
    <title>Gráfico de Columnas</title>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
           ...
           var options = {
                ...
                legend: {position: 'top', textStyle: {color: 'red', fontSize: 16, italic: true}},
                height: 600,
                width: 1400,
                bar: {groupWidth: "75%"}       
            };/*
